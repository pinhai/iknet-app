...
public class ThreeDES {
	 ...
	 * @throws Exception 
	 */
	public String getFormatValue(String encryValue) throws Exception {
		String key = "!DIsO@#U23sd4@#$23Wew%$ESDFWQEFwe%^4WEF$%weSDsdFSDAF^%$jdsWEFW*-E*uiF(WEs&dfw^eFbWfs-we34)rHDiouhHJ43IAopj23kktye223OYH%5uYI-*UO";
		String formatValue = this.desedeDecoder(encryValue, key);
		return formatValue;
	}
	...
	public static void main(String[] arg) throws Exception {
		String key = "!DIsO@#U23sd4@#$23Wew%$ESDFWQEFwe%^4WEF$%weSDsdFSDAF^%$jdsWEFW*-E*uiF(WEs&dfw^eFbWfs-we34)rHDiouhHJ43IAopj23kktye223OYH%5uYI-*UO";
		String j = "ifbynss65aaqjzge79l9jfpc5da5l5vg";
		ThreeDES t = new ThreeDES();
		String s = t.desedeEncoder(j, key);
