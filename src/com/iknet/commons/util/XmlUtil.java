...
public class XmlUtil
{
    ...
    public static Map<Object, Object> getNodeValues(Element element)
    {
    ...
    public static void main(String[] args)
    {
        ...
        {
            String xml =
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?><Response><Result>0</Result><Mo num=\"2\"><Item id=\"1\" content=\"上行01\" from_mobile=\"13500000000\" to_port=\"0001\" rec_time=\"2013-07-20 13:23:45\"/><Item id=\"2\" content=\"上行02\" from_mobile=\"13600000000\" to_port=\"0002\" rec_time=\"2013-07-20 13:23:45\"/></Mo></Response >";
            ...
            for (int i = 0; i < list.size(); i++)
            {
                ...
                System.out.println("id = " + item.attributeValue("id")
                    + " content = " + item.attributeValue("content")
                    + " from_mobile = " + item.attributeValue("from_mobile")
                    + " to_port = " + item.attributeValue("to_port")
                    + " rec_time = " + item.attributeValue("rec_time"));
            }
